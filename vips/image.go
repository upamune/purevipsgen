...
func NewAnalyzeload(filename string, options *AnalyzeloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenAnalyzeloadWithOptions(filename, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeAnalyze, nil), nil
	}
	vipsImage, err := purevipsgenAnalyzeload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeAnalyze, nil), nil
...
func NewArrayjoin(in []*Image, options *ArrayjoinOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenArrayjoinWithOptions(convertImagesToVipsImages(in), options.Across, options.Shim, options.Background, options.Halign, options.Valign, options.Hspacing, options.Vspacing)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenArrayjoin(convertImagesToVipsImages(in))
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewBandjoin(in []*Image) (*Image, error) {
	Startup(nil)
	vipsImage, err := purevipsgenBandjoin(convertImagesToVipsImages(in))
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewBandrank(in []*Image, options *BandrankOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenBandrankWithOptions(convertImagesToVipsImages(in), options.Index)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenBandrank(convertImagesToVipsImages(in))
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewBlack(width int, height int, options *BlackOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenBlackWithOptions(width, height, options.Bands)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenBlack(width, height)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewComposite(in []*Image, mode []BlendMode, options *CompositeOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenCompositeWithOptions(convertImagesToVipsImages(in), mode, options.X, options.Y, options.CompositingSpace, options.Premultiplied)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenComposite(convertImagesToVipsImages(in), mode)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewCsvload(filename string, options *CsvloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenCsvloadWithOptions(filename, options.Skip, options.Lines, options.Whitespace, options.Separator, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeCsv, nil), nil
	}
	vipsImage, err := purevipsgenCsvload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeCsv, nil), nil
...
func NewCsvloadSource(source *Source, options *CsvloadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenCsvloadSourceWithOptions(source.src, options.Skip, options.Lines, options.Whitespace, options.Separator, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeCsv, nil), nil
	}
	vipsImage, err := purevipsgenCsvloadSource(source.src)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeCsv, nil), nil
...
func NewEye(width int, height int, options *EyeOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenEyeWithOptions(width, height, options.Uchar, options.Factor)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenEye(width, height)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewFitsload(filename string, options *FitsloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenFitsloadWithOptions(filename, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeFits, nil), nil
	}
	vipsImage, err := purevipsgenFitsload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeFits, nil), nil
...
func NewFractsurf(width int, height int, fractalDimension float64) (*Image, error) {
	Startup(nil)
	vipsImage, err := purevipsgenFractsurf(width, height, fractalDimension)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewGaussmat(sigma float64, minAmpl float64, options *GaussmatOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenGaussmatWithOptions(sigma, minAmpl, options.Separable, options.Precision)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenGaussmat(sigma, minAmpl)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewGaussnoise(width int, height int, options *GaussnoiseOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenGaussnoiseWithOptions(width, height, options.Sigma, options.Mean, options.Seed)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenGaussnoise(width, height)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewGifload(filename string, options *GifloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenGifloadWithOptions(filename, options.N, options.Page, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeGif, nil), nil
	}
	vipsImage, err := purevipsgenGifload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeGif, nil), nil
...
func NewGifloadBuffer(buf []byte, options *GifloadBufferOptions) (*Image, error) {
	...
	if options != nil {
		vipsImage, err := purevipsgenGifloadBufferWithOptions(buf, options.N, options.Page, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeGif, buf), nil
	}
	vipsImage, err := purevipsgenGifloadBuffer(buf)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeGif, buf), nil
...
func NewGifloadSource(source *Source, options *GifloadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenGifloadSourceWithOptions(source.src, options.N, options.Page, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeGif, nil), nil
	}
	vipsImage, err := purevipsgenGifloadSource(source.src)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeGif, nil), nil
...
func NewGrey(width int, height int, options *GreyOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenGreyWithOptions(width, height, options.Uchar)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenGrey(width, height)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewHeifload(filename string, options *HeifloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenHeifloadWithOptions(filename, options.Page, options.N, options.Thumbnail, options.Unlimited, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeHeif, nil), nil
	}
	vipsImage, err := purevipsgenHeifload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeHeif, nil), nil
...
func NewHeifloadBuffer(buf []byte, options *HeifloadBufferOptions) (*Image, error) {
	...
	if options != nil {
		vipsImage, err := purevipsgenHeifloadBufferWithOptions(buf, options.Page, options.N, options.Thumbnail, options.Unlimited, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeHeif, buf), nil
	}
	vipsImage, err := purevipsgenHeifloadBuffer(buf)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeHeif, buf), nil
...
func NewHeifloadSource(source *Source, options *HeifloadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenHeifloadSourceWithOptions(source.src, options.Page, options.N, options.Thumbnail, options.Unlimited, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeHeif, nil), nil
	}
	vipsImage, err := purevipsgenHeifloadSource(source.src)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeHeif, nil), nil
...
func NewIdentity(options *IdentityOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenIdentityWithOptions(options.Bands, options.Ushort, options.Size)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenIdentity()
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewJp2kload(filename string, options *Jp2kloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenJp2kloadWithOptions(filename, options.Page, options.Oneshot, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeJp2k, nil), nil
	}
	vipsImage, err := purevipsgenJp2kload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeJp2k, nil), nil
...
func NewJp2kloadBuffer(buf []byte, options *Jp2kloadBufferOptions) (*Image, error) {
	...
	if options != nil {
		vipsImage, err := purevipsgenJp2kloadBufferWithOptions(buf, options.Page, options.Oneshot, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeJp2k, buf), nil
	}
	vipsImage, err := purevipsgenJp2kloadBuffer(buf)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeJp2k, buf), nil
...
func NewJp2kloadSource(source *Source, options *Jp2kloadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenJp2kloadSourceWithOptions(source.src, options.Page, options.Oneshot, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeJp2k, nil), nil
	}
	vipsImage, err := purevipsgenJp2kloadSource(source.src)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeJp2k, nil), nil
...
func NewJpegload(filename string, options *JpegloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenJpegloadWithOptions(filename, options.Shrink, options.Autorotate, options.Unlimited, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeJpeg, nil), nil
	}
	vipsImage, err := purevipsgenJpegload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeJpeg, nil), nil
...
func NewJpegloadBuffer(buf []byte, options *JpegloadBufferOptions) (*Image, error) {
	...
	if options != nil {
		vipsImage, err := purevipsgenJpegloadBufferWithOptions(buf, options.Shrink, options.Autorotate, options.Unlimited, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeJpeg, buf), nil
	}
	vipsImage, err := purevipsgenJpegloadBuffer(buf)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeJpeg, buf), nil
...
func NewJpegloadSource(source *Source, options *JpegloadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenJpegloadSourceWithOptions(source.src, options.Shrink, options.Autorotate, options.Unlimited, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeJpeg, nil), nil
	}
	vipsImage, err := purevipsgenJpegloadSource(source.src)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeJpeg, nil), nil
...
func NewJxlload(filename string, options *JxlloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenJxlloadWithOptions(filename, options.Page, options.N, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeJxl, nil), nil
	}
	vipsImage, err := purevipsgenJxlload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeJxl, nil), nil
...
func NewJxlloadBuffer(buf []byte, options *JxlloadBufferOptions) (*Image, error) {
	...
	if options != nil {
		vipsImage, err := purevipsgenJxlloadBufferWithOptions(buf, options.Page, options.N, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeJxl, buf), nil
	}
	vipsImage, err := purevipsgenJxlloadBuffer(buf)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeJxl, buf), nil
...
func NewJxlloadSource(source *Source, options *JxlloadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenJxlloadSourceWithOptions(source.src, options.Page, options.N, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeJxl, nil), nil
	}
	vipsImage, err := purevipsgenJxlloadSource(source.src)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeJxl, nil), nil
...
func NewLogmat(sigma float64, minAmpl float64, options *LogmatOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenLogmatWithOptions(sigma, minAmpl, options.Separable, options.Precision)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenLogmat(sigma, minAmpl)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewMagickload(filename string, options *MagickloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenMagickloadWithOptions(filename, options.Density, options.Page, options.N, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeMagick, nil), nil
	}
	vipsImage, err := purevipsgenMagickload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeMagick, nil), nil
...
func NewMagickloadBuffer(buf []byte, options *MagickloadBufferOptions) (*Image, error) {
	...
	if options != nil {
		vipsImage, err := purevipsgenMagickloadBufferWithOptions(buf, options.Density, options.Page, options.N, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeMagick, buf), nil
	}
	vipsImage, err := purevipsgenMagickloadBuffer(buf)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeMagick, buf), nil
...
func NewMaskButterworth(width int, height int, order float64, frequencyCutoff float64, amplitudeCutoff float64, options *MaskButterworthOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenMaskButterworthWithOptions(width, height, order, frequencyCutoff, amplitudeCutoff, options.Uchar, options.Nodc, options.Reject, options.Optical)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenMaskButterworth(width, height, order, frequencyCutoff, amplitudeCutoff)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewMaskButterworthBand(width int, height int, order float64, frequencyCutoffX float64, frequencyCutoffY float64, radius float64, amplitudeCutoff float64, options *MaskButterworthBandOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenMaskButterworthBandWithOptions(width, height, order, frequencyCutoffX, frequencyCutoffY, radius, amplitudeCutoff, options.Uchar, options.Nodc, options.Reject, options.Optical)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenMaskButterworthBand(width, height, order, frequencyCutoffX, frequencyCutoffY, radius, amplitudeCutoff)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewMaskButterworthRing(width int, height int, order float64, frequencyCutoff float64, amplitudeCutoff float64, ringwidth float64, options *MaskButterworthRingOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenMaskButterworthRingWithOptions(width, height, order, frequencyCutoff, amplitudeCutoff, ringwidth, options.Uchar, options.Nodc, options.Reject, options.Optical)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenMaskButterworthRing(width, height, order, frequencyCutoff, amplitudeCutoff, ringwidth)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewMaskFractal(width int, height int, fractalDimension float64, options *MaskFractalOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenMaskFractalWithOptions(width, height, fractalDimension, options.Uchar, options.Nodc, options.Reject, options.Optical)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenMaskFractal(width, height, fractalDimension)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewMaskGaussian(width int, height int, frequencyCutoff float64, amplitudeCutoff float64, options *MaskGaussianOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenMaskGaussianWithOptions(width, height, frequencyCutoff, amplitudeCutoff, options.Uchar, options.Nodc, options.Reject, options.Optical)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenMaskGaussian(width, height, frequencyCutoff, amplitudeCutoff)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewMaskGaussianBand(width int, height int, frequencyCutoffX float64, frequencyCutoffY float64, radius float64, amplitudeCutoff float64, options *MaskGaussianBandOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenMaskGaussianBandWithOptions(width, height, frequencyCutoffX, frequencyCutoffY, radius, amplitudeCutoff, options.Uchar, options.Nodc, options.Reject, options.Optical)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenMaskGaussianBand(width, height, frequencyCutoffX, frequencyCutoffY, radius, amplitudeCutoff)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewMaskGaussianRing(width int, height int, frequencyCutoff float64, amplitudeCutoff float64, ringwidth float64, options *MaskGaussianRingOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenMaskGaussianRingWithOptions(width, height, frequencyCutoff, amplitudeCutoff, ringwidth, options.Uchar, options.Nodc, options.Reject, options.Optical)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenMaskGaussianRing(width, height, frequencyCutoff, amplitudeCutoff, ringwidth)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewMaskIdeal(width int, height int, frequencyCutoff float64, options *MaskIdealOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenMaskIdealWithOptions(width, height, frequencyCutoff, options.Uchar, options.Nodc, options.Reject, options.Optical)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenMaskIdeal(width, height, frequencyCutoff)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewMaskIdealBand(width int, height int, frequencyCutoffX float64, frequencyCutoffY float64, radius float64, options *MaskIdealBandOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenMaskIdealBandWithOptions(width, height, frequencyCutoffX, frequencyCutoffY, radius, options.Uchar, options.Nodc, options.Reject, options.Optical)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenMaskIdealBand(width, height, frequencyCutoffX, frequencyCutoffY, radius)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewMaskIdealRing(width int, height int, frequencyCutoff float64, ringwidth float64, options *MaskIdealRingOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenMaskIdealRingWithOptions(width, height, frequencyCutoff, ringwidth, options.Uchar, options.Nodc, options.Reject, options.Optical)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenMaskIdealRing(width, height, frequencyCutoff, ringwidth)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewMatload(filename string, options *MatloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenMatloadWithOptions(filename, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeMat, nil), nil
	}
	vipsImage, err := purevipsgenMatload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeMat, nil), nil
...
func NewMatrixload(filename string, options *MatrixloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenMatrixloadWithOptions(filename, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeMatrix, nil), nil
	}
	vipsImage, err := purevipsgenMatrixload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeMatrix, nil), nil
...
func NewMatrixloadSource(source *Source, options *MatrixloadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenMatrixloadSourceWithOptions(source.src, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeMatrix, nil), nil
	}
	vipsImage, err := purevipsgenMatrixloadSource(source.src)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeMatrix, nil), nil
...
func NewOpenexrload(filename string, options *OpenexrloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenOpenexrloadWithOptions(filename, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeOpenexr, nil), nil
	}
	vipsImage, err := purevipsgenOpenexrload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeOpenexr, nil), nil
...
func NewOpenslideload(filename string, options *OpenslideloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenOpenslideloadWithOptions(filename, options.Level, options.Autocrop, options.Associated, options.AttachAssociated, options.Rgb, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeOpenslide, nil), nil
	}
	vipsImage, err := purevipsgenOpenslideload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeOpenslide, nil), nil
...
func NewOpenslideloadSource(source *Source, options *OpenslideloadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenOpenslideloadSourceWithOptions(source.src, options.Level, options.Autocrop, options.Associated, options.AttachAssociated, options.Rgb, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeOpenslide, nil), nil
	}
	vipsImage, err := purevipsgenOpenslideloadSource(source.src)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeOpenslide, nil), nil
...
func NewPdfload(filename string, options *PdfloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenPdfloadWithOptions(filename, options.Page, options.N, options.Dpi, options.Scale, options.Background, options.Password, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypePdf, nil), nil
	}
	vipsImage, err := purevipsgenPdfload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypePdf, nil), nil
...
func NewPdfloadBuffer(buf []byte, options *PdfloadBufferOptions) (*Image, error) {
	...
	if options != nil {
		vipsImage, err := purevipsgenPdfloadBufferWithOptions(buf, options.Page, options.N, options.Dpi, options.Scale, options.Background, options.Password, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypePdf, buf), nil
	}
	vipsImage, err := purevipsgenPdfloadBuffer(buf)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypePdf, buf), nil
...
func NewPdfloadSource(source *Source, options *PdfloadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenPdfloadSourceWithOptions(source.src, options.Page, options.N, options.Dpi, options.Scale, options.Background, options.Password, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypePdf, nil), nil
	}
	vipsImage, err := purevipsgenPdfloadSource(source.src)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypePdf, nil), nil
...
func NewPerlin(width int, height int, options *PerlinOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenPerlinWithOptions(width, height, options.CellSize, options.Uchar, options.Seed)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenPerlin(width, height)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewPngload(filename string, options *PngloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenPngloadWithOptions(filename, options.Unlimited, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypePng, nil), nil
	}
	vipsImage, err := purevipsgenPngload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypePng, nil), nil
...
func NewPngloadBuffer(buf []byte, options *PngloadBufferOptions) (*Image, error) {
	...
	if options != nil {
		vipsImage, err := purevipsgenPngloadBufferWithOptions(buf, options.Unlimited, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypePng, buf), nil
	}
	vipsImage, err := purevipsgenPngloadBuffer(buf)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypePng, buf), nil
...
func NewPngloadSource(source *Source, options *PngloadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenPngloadSourceWithOptions(source.src, options.Unlimited, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypePng, nil), nil
	}
	vipsImage, err := purevipsgenPngloadSource(source.src)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypePng, nil), nil
...
func NewPpmload(filename string, options *PpmloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenPpmloadWithOptions(filename, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypePpm, nil), nil
	}
	vipsImage, err := purevipsgenPpmload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypePpm, nil), nil
...
func NewPpmloadBuffer(buf []byte, options *PpmloadBufferOptions) (*Image, error) {
	...
	if options != nil {
		vipsImage, err := purevipsgenPpmloadBufferWithOptions(buf, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypePpm, buf), nil
	}
	vipsImage, err := purevipsgenPpmloadBuffer(buf)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypePpm, buf), nil
...
func NewPpmloadSource(source *Source, options *PpmloadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenPpmloadSourceWithOptions(source.src, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypePpm, nil), nil
	}
	vipsImage, err := purevipsgenPpmloadSource(source.src)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypePpm, nil), nil
...
func NewRadload(filename string, options *RadloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenRadloadWithOptions(filename, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeRad, nil), nil
	}
	vipsImage, err := purevipsgenRadload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeRad, nil), nil
...
func NewRadloadBuffer(buf []byte, options *RadloadBufferOptions) (*Image, error) {
	...
	if options != nil {
		vipsImage, err := purevipsgenRadloadBufferWithOptions(buf, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeRad, buf), nil
	}
	vipsImage, err := purevipsgenRadloadBuffer(buf)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeRad, buf), nil
...
func NewRadloadSource(source *Source, options *RadloadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenRadloadSourceWithOptions(source.src, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeRad, nil), nil
	}
	vipsImage, err := purevipsgenRadloadSource(source.src)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeRad, nil), nil
...
func NewRawload(filename string, width int, height int, bands int, options *RawloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenRawloadWithOptions(filename, width, height, bands, options.Offset, options.Format, options.Interpretation, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeRaw, nil), nil
	}
	vipsImage, err := purevipsgenRawload(filename, width, height, bands)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeRaw, nil), nil
...
func NewSdf(width int, height int, shape SdfShape, options *SdfOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenSdfWithOptions(width, height, shape, options.R, options.A, options.B, options.Corners)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenSdf(width, height, shape)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewSines(width int, height int, options *SinesOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenSinesWithOptions(width, height, options.Uchar, options.Hfreq, options.Vfreq)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenSines(width, height)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewSum(in []*Image) (*Image, error) {
	Startup(nil)
	vipsImage, err := purevipsgenSum(convertImagesToVipsImages(in))
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewSvgload(filename string, options *SvgloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenSvgloadWithOptions(filename, options.Dpi, options.Scale, options.Unlimited, options.Stylesheet, options.HighBitdepth, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeSvg, nil), nil
	}
	vipsImage, err := purevipsgenSvgload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeSvg, nil), nil
...
func NewSvgloadBuffer(buf []byte, options *SvgloadBufferOptions) (*Image, error) {
	...
	if options != nil {
		vipsImage, err := purevipsgenSvgloadBufferWithOptions(buf, options.Dpi, options.Scale, options.Unlimited, options.Stylesheet, options.HighBitdepth, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeSvg, buf), nil
	}
	vipsImage, err := purevipsgenSvgloadBuffer(buf)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeSvg, buf), nil
...
func NewSvgloadSource(source *Source, options *SvgloadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenSvgloadSourceWithOptions(source.src, options.Dpi, options.Scale, options.Unlimited, options.Stylesheet, options.HighBitdepth, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeSvg, nil), nil
	}
	vipsImage, err := purevipsgenSvgloadSource(source.src)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeSvg, nil), nil
...
func NewSwitch(tests []*Image) (*Image, error) {
	Startup(nil)
	vipsImage, err := purevipsgenSwitch(convertImagesToVipsImages(tests))
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewSystem(cmdFormat string, options *SystemOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenSystemWithOptions(cmdFormat, convertImagesToVipsImages(options.In), options.OutFormat, options.InFormat)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenSystem(cmdFormat)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewText(text string, options *TextOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenTextWithOptions(text, options.Font, options.Width, options.Height, options.Align, options.Justify, options.Dpi, options.Spacing, options.Fontfile, options.Rgba, options.Wrap, &options.AutofitDpi)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenText(text)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewThumbnail(filename string, width int, options *ThumbnailOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenThumbnailWithOptions(filename, width, options.Height, options.Size, options.NoRotate, options.Crop, options.Linear, options.InputProfile, options.OutputProfile, options.Intent, options.FailOn)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, vipsDetermineImageType(vipsImage), nil), nil
	}
	vipsImage, err := purevipsgenThumbnail(filename, width)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, vipsDetermineImageType(vipsImage), nil), nil
...
func NewThumbnailBuffer(buf []byte, width int, options *ThumbnailBufferOptions) (*Image, error) {
	...
	if options != nil {
		vipsImage, err := purevipsgenThumbnailBufferWithOptions(buf, width, options.OptionString, options.Height, options.Size, options.NoRotate, options.Crop, options.Linear, options.InputProfile, options.OutputProfile, options.Intent, options.FailOn)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, vipsDetermineImageType(vipsImage), buf), nil
	}
	vipsImage, err := purevipsgenThumbnailBuffer(buf, width)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, vipsDetermineImageType(vipsImage), buf), nil
...
func NewThumbnailSource(source *Source, width int, options *ThumbnailSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenThumbnailSourceWithOptions(source.src, width, options.OptionString, options.Height, options.Size, options.NoRotate, options.Crop, options.Linear, options.InputProfile, options.OutputProfile, options.Intent, options.FailOn)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, vipsDetermineImageType(vipsImage), nil), nil
	}
	vipsImage, err := purevipsgenThumbnailSource(source.src, width)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, vipsDetermineImageType(vipsImage), nil), nil
...
func NewTiffload(filename string, options *TiffloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenTiffloadWithOptions(filename, options.Page, options.N, options.Autorotate, options.Subifd, options.Unlimited, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeTiff, nil), nil
	}
	vipsImage, err := purevipsgenTiffload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeTiff, nil), nil
...
func NewTiffloadBuffer(buf []byte, options *TiffloadBufferOptions) (*Image, error) {
	...
	if options != nil {
		vipsImage, err := purevipsgenTiffloadBufferWithOptions(buf, options.Page, options.N, options.Autorotate, options.Subifd, options.Unlimited, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeTiff, buf), nil
	}
	vipsImage, err := purevipsgenTiffloadBuffer(buf)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeTiff, buf), nil
...
func NewTiffloadSource(source *Source, options *TiffloadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenTiffloadSourceWithOptions(source.src, options.Page, options.N, options.Autorotate, options.Subifd, options.Unlimited, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeTiff, nil), nil
	}
	vipsImage, err := purevipsgenTiffloadSource(source.src)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeTiff, nil), nil
...
func NewTonelut(options *TonelutOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenTonelutWithOptions(options.InMax, options.OutMax, options.Lb, options.Lw, options.Ps, options.Pm, options.Ph, options.S, options.M, options.H)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenTonelut()
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewVipsload(filename string, options *VipsloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenVipsloadWithOptions(filename, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeVips, nil), nil
	}
	vipsImage, err := purevipsgenVipsload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeVips, nil), nil
...
func NewVipsloadSource(source *Source, options *VipsloadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenVipsloadSourceWithOptions(source.src, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeVips, nil), nil
	}
	vipsImage, err := purevipsgenVipsloadSource(source.src)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeVips, nil), nil
...
func NewWebpload(filename string, options *WebploadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenWebploadWithOptions(filename, options.Page, options.N, options.Scale, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeWebp, nil), nil
	}
	vipsImage, err := purevipsgenWebpload(filename)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeWebp, nil), nil
...
func NewWebploadBuffer(buf []byte, options *WebploadBufferOptions) (*Image, error) {
	...
	if options != nil {
		vipsImage, err := purevipsgenWebploadBufferWithOptions(buf, options.Page, options.N, options.Scale, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeWebp, buf), nil
	}
	vipsImage, err := purevipsgenWebploadBuffer(buf)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeWebp, buf), nil
...
func NewWebploadSource(source *Source, options *WebploadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenWebploadSourceWithOptions(source.src, options.Page, options.N, options.Scale, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeWebp, nil), nil
	}
	vipsImage, err := purevipsgenWebploadSource(source.src)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeWebp, nil), nil
...
func NewWorley(width int, height int, options *WorleyOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenWorleyWithOptions(width, height, options.CellSize, options.Seed)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenWorley(width, height)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewXyz(width int, height int, options *XyzOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenXyzWithOptions(width, height, options.Csize, options.Dsize, options.Esize)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenXyz(width, height)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func NewZone(width int, height int, options *ZoneOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := purevipsgenZoneWithOptions(width, height, options.Uchar)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
	}
	vipsImage, err := purevipsgenZone(width, height)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, ImageTypeUnknown, nil), nil
...
func (r *Image) CMC2LCh() (error) {
	out, err := purevipsgenCMC2LCh(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) CMYK2XYZ() (error) {
	out, err := purevipsgenCMYK2XYZ(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) HSV2sRGB() (error) {
	out, err := purevipsgenHSV2sRGB(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) LCh2CMC() (error) {
	out, err := purevipsgenLCh2CMC(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) LCh2Lab() (error) {
	out, err := purevipsgenLCh2Lab(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Lab2LCh() (error) {
	out, err := purevipsgenLab2LCh(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Lab2LabQ() (error) {
	out, err := purevipsgenLab2LabQ(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Lab2LabS() (error) {
	out, err := purevipsgenLab2LabS(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Lab2XYZ(options *Lab2XYZOptions) (error) {
	if options != nil {
		out, err := purevipsgenLab2XYZWithOptions(r.image, options.Temp)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenLab2XYZ(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) LabQ2Lab() (error) {
	out, err := purevipsgenLabQ2Lab(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) LabQ2LabS() (error) {
	out, err := purevipsgenLabQ2LabS(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) LabQ2sRGB() (error) {
	out, err := purevipsgenLabQ2sRGB(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) LabS2Lab() (error) {
	out, err := purevipsgenLabS2Lab(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) LabS2LabQ() (error) {
	out, err := purevipsgenLabS2LabQ(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) XYZ2CMYK() (error) {
	out, err := purevipsgenXYZ2CMYK(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) XYZ2Lab(options *XYZ2LabOptions) (error) {
	if options != nil {
		out, err := purevipsgenXYZ2LabWithOptions(r.image, options.Temp)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenXYZ2Lab(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) XYZ2Yxy() (error) {
	out, err := purevipsgenXYZ2Yxy(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) XYZ2scRGB() (error) {
	out, err := purevipsgenXYZ2scRGB(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Yxy2XYZ() (error) {
	out, err := purevipsgenYxy2XYZ(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Abs() (error) {
	out, err := purevipsgenAbs(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Add(right *Image) (error) {
	out, err := purevipsgenAdd(r.image, right.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Addalpha() (error) {
	out, err := purevipsgenAddalpha(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Affine(a float64, b float64, c float64, d float64, options *AffineOptions) (error) {
	if options != nil {
		out, err := purevipsgenAffineWithOptions(r.image, a, b, c, d, options.Interpolate, options.Oarea, options.Odx, options.Ody, options.Idx, options.Idy, options.Background, options.Premultiplied, options.Extend)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenAffine(r.image, a, b, c, d)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Autorot(options *AutorotOptions) (error) {
	if options != nil {
		out, err := purevipsgenAutorotWithOptions(r.image, &options.Flip)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenAutorot(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Avg() (float64, error) {
	out, err := purevipsgenAvg(r.image)
	if err != nil {
		return 0, err
	}
	return out, nil
...
func (r *Image) Bandbool(boolean OperationBoolean) (error) {
	out, err := purevipsgenBandbool(r.image, boolean)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Bandfold(options *BandfoldOptions) (error) {
	if options != nil {
		out, err := purevipsgenBandfoldWithOptions(r.image, options.Factor)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenBandfold(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) BandjoinConst(c []float64) (error) {
	out, err := purevipsgenBandjoinConst(r.image, c)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Bandmean() (error) {
	out, err := purevipsgenBandmean(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Bandunfold(options *BandunfoldOptions) (error) {
	if options != nil {
		out, err := purevipsgenBandunfoldWithOptions(r.image, options.Factor)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenBandunfold(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Boolean(right *Image, boolean OperationBoolean) (error) {
	out, err := purevipsgenBoolean(r.image, right.image, boolean)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) BooleanConst(boolean OperationBoolean, c []float64) (error) {
	out, err := purevipsgenBooleanConst(r.image, boolean, c)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Buildlut() (error) {
	out, err := purevipsgenBuildlut(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Byteswap() (error) {
	out, err := purevipsgenByteswap(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Canny(options *CannyOptions) (error) {
	if options != nil {
		out, err := purevipsgenCannyWithOptions(r.image, options.Sigma, options.Precision)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenCanny(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Case(cases []*Image) (error) {
	out, err := purevipsgenCase(r.image, convertImagesToVipsImages(cases))
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Cast(format BandFormat, options *CastOptions) (error) {
	if options != nil {
		out, err := purevipsgenCastWithOptions(r.image, format, options.Shift)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenCast(r.image, format)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Clamp(options *ClampOptions) (error) {
	if options != nil {
		out, err := purevipsgenClampWithOptions(r.image, options.Min, options.Max)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenClamp(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Colourspace(space Interpretation, options *ColourspaceOptions) (error) {
	if options != nil {
		out, err := purevipsgenColourspaceWithOptions(r.image, space, options.SourceSpace)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenColourspace(r.image, space)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Compass(mask *Image, options *CompassOptions) (error) {
	if options != nil {
		out, err := purevipsgenCompassWithOptions(r.image, mask.image, options.Times, options.Angle, options.Combine, options.Precision, options.Layers, options.Cluster)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenCompass(r.image, mask.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Complex(cmplx OperationComplex) (error) {
	out, err := purevipsgenComplex(r.image, cmplx)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Complex2(right *Image, cmplx OperationComplex2) (error) {
	out, err := purevipsgenComplex2(r.image, right.image, cmplx)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Complexform(right *Image) (error) {
	out, err := purevipsgenComplexform(r.image, right.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Complexget(get OperationComplexget) (error) {
	out, err := purevipsgenComplexget(r.image, get)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Composite2(overlay *Image, mode BlendMode, options *Composite2Options) (error) {
	if options != nil {
		out, err := purevipsgenComposite2WithOptions(r.image, overlay.image, mode, options.X, options.Y, options.CompositingSpace, options.Premultiplied)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenComposite2(r.image, overlay.image, mode)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Conv(mask *Image, options *ConvOptions) (error) {
	if options != nil {
		out, err := purevipsgenConvWithOptions(r.image, mask.image, options.Precision, options.Layers, options.Cluster)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenConv(r.image, mask.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Conva(mask *Image, options *ConvaOptions) (error) {
	if options != nil {
		out, err := purevipsgenConvaWithOptions(r.image, mask.image, options.Layers, options.Cluster)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenConva(r.image, mask.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Convasep(mask *Image, options *ConvasepOptions) (error) {
	if options != nil {
		out, err := purevipsgenConvasepWithOptions(r.image, mask.image, options.Layers)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenConvasep(r.image, mask.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Convf(mask *Image) (error) {
	out, err := purevipsgenConvf(r.image, mask.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Convi(mask *Image) (error) {
	out, err := purevipsgenConvi(r.image, mask.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Convsep(mask *Image, options *ConvsepOptions) (error) {
	if options != nil {
		out, err := purevipsgenConvsepWithOptions(r.image, mask.image, options.Precision, options.Layers, options.Cluster)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenConvsep(r.image, mask.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Copy(options *CopyOptions) (*Image, error) {
	if options != nil {
		out, err := purevipsgenCopyWithOptions(r.image, options.Width, options.Height, options.Bands, options.Format, options.Coding, options.Interpretation, options.Xres, options.Yres, options.Xoffset, options.Yoffset)
		if err != nil {
			return nil, err
		}
	...
	out, err := purevipsgenCopy(r.image)
	if err != nil {
		return nil, err
	}
	outImage := newImageRef(out, r.format, nil)
...
func (r *Image) Countlines(direction Direction) (float64, error) {
	out, err := purevipsgenCountlines(r.image, direction)
	if err != nil {
		return 0, err
	}
	return out, nil
...
func (r *Image) Csvsave(filename string, options *CsvsaveOptions) (error) {
	if options != nil {
		err := purevipsgenCsvsaveWithOptions(r.image, filename, options.Separator, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenCsvsave(r.image, filename)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) CsvsaveTarget(target *Target, options *CsvsaveTargetOptions) (error) {
	if options != nil {
		err := purevipsgenCsvsaveTargetWithOptions(r.image, target.target, options.Separator, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenCsvsaveTarget(r.image, target.target)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) DE00(right *Image) (error) {
	out, err := purevipsgenDE00(r.image, right.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) DE76(right *Image) (error) {
	out, err := purevipsgenDE76(r.image, right.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) DECMC(right *Image) (error) {
	out, err := purevipsgenDECMC(r.image, right.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Deviate() (float64, error) {
	out, err := purevipsgenDeviate(r.image)
	if err != nil {
		return 0, err
	}
	return out, nil
...
func (r *Image) Divide(right *Image) (error) {
	out, err := purevipsgenDivide(r.image, right.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) DrawCircle(ink []float64, cx int, cy int, radius int, options *DrawCircleOptions) (error) {
	if options != nil {
		err := purevipsgenDrawCircleWithOptions(r.image, ink, cx, cy, radius, options.Fill)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenDrawCircle(r.image, ink, cx, cy, radius)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) DrawFlood(ink []float64, x int, y int, options *DrawFloodOptions) (error) {
	if options != nil {
		err := purevipsgenDrawFloodWithOptions(r.image, ink, x, y, getImagePointer(options.Test), options.Equal, &options.Left, &options.Top, &options.Width, &options.Height)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenDrawFlood(r.image, ink, x, y)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) DrawImage(sub *Image, x int, y int, options *DrawImageOptions) (error) {
	if options != nil {
		err := purevipsgenDrawImageWithOptions(r.image, sub.image, x, y, options.Mode)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenDrawImage(r.image, sub.image, x, y)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) DrawLine(ink []float64, x1 int, y1 int, x2 int, y2 int) (error) {
	err := purevipsgenDrawLine(r.image, ink, x1, y1, x2, y2)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) DrawMask(ink []float64, mask *Image, x int, y int) (error) {
	err := purevipsgenDrawMask(r.image, ink, mask.image, x, y)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) DrawRect(ink []float64, left int, top int, width int, height int, options *DrawRectOptions) (error) {
	if options != nil {
		err := purevipsgenDrawRectWithOptions(r.image, ink, left, top, width, height, options.Fill)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenDrawRect(r.image, ink, left, top, width, height)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) DrawSmudge(left int, top int, width int, height int) (error) {
	err := purevipsgenDrawSmudge(r.image, left, top, width, height)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) DzsaveBuffer(options *DzsaveBufferOptions) ([]byte, error) {
	if options != nil {
		buf, err := purevipsgenDzsaveBufferWithOptions(r.image, options.Imagename, options.Layout, options.Suffix, options.Overlap, options.TileSize, options.Centre, options.Depth, options.Angle, options.Container, options.Compression, options.RegionShrink, options.SkipBlanks, options.Id, options.Q, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return nil, err
		}
		return buf, nil
	}
	buf, err := purevipsgenDzsaveBuffer(r.image)
	if err != nil {
		return nil, err
	}
	return buf, nil
...
func (r *Image) DzsaveTarget(target *Target, options *DzsaveTargetOptions) (error) {
	if options != nil {
		err := purevipsgenDzsaveTargetWithOptions(r.image, target.target, options.Imagename, options.Layout, options.Suffix, options.Overlap, options.TileSize, options.Centre, options.Depth, options.Angle, options.Container, options.Compression, options.RegionShrink, options.SkipBlanks, options.Id, options.Q, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenDzsaveTarget(r.image, target.target)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) Embed(x int, y int, width int, height int, options *EmbedOptions) (error) {
	if options != nil {
		out, err := purevipsgenEmbedWithOptions(r.image, x, y, width, height, options.Extend, options.Background)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenEmbed(r.image, x, y, width, height)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) ExtractArea(left int, top int, width int, height int) (error) {
	out, err := purevipsgenExtractArea(r.image, left, top, width, height)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) ExtractBand(band int, options *ExtractBandOptions) (error) {
	if options != nil {
		out, err := purevipsgenExtractBandWithOptions(r.image, band, options.N)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenExtractBand(r.image, band)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Falsecolour() (error) {
	out, err := purevipsgenFalsecolour(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Fastcor(ref *Image) (error) {
	out, err := purevipsgenFastcor(r.image, ref.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) FillNearest() (*Image, error) {
	out, err := purevipsgenFillNearest(r.image)
	if err != nil {
		return nil, err
	}
	outImage := newImageRef(out, r.format, nil)
...
func (r *Image) FindTrim(options *FindTrimOptions) (int, int, int, int, error) {
	if options != nil {
		left, top, width, height, err := purevipsgenFindTrimWithOptions(r.image, options.Threshold, options.Background, options.LineArt)
		if err != nil {
			return 0, 0, 0, 0, err
		}
		return left, top, width, height, nil
	}
	left, top, width, height, err := purevipsgenFindTrim(r.image)
	if err != nil {
		return 0, 0, 0, 0, err
	}
	return left, top, width, height, nil
...
func (r *Image) Fitssave(filename string, options *FitssaveOptions) (error) {
	if options != nil {
		err := purevipsgenFitssaveWithOptions(r.image, filename, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenFitssave(r.image, filename)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) Flatten(options *FlattenOptions) (error) {
	if options != nil {
		out, err := purevipsgenFlattenWithOptions(r.image, options.Background, options.MaxAlpha)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenFlatten(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Flip(direction Direction) (error) {
	out, err := purevipsgenFlip(r.image, direction)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Float2rad() (error) {
	out, err := purevipsgenFloat2rad(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Freqmult(mask *Image) (error) {
	out, err := purevipsgenFreqmult(r.image, mask.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Fwfft() (error) {
	out, err := purevipsgenFwfft(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Gamma(options *GammaOptions) (error) {
	if options != nil {
		out, err := purevipsgenGammaWithOptions(r.image, options.Exponent)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenGamma(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Gaussblur(sigma float64, options *GaussblurOptions) (error) {
	if options != nil {
		out, err := purevipsgenGaussblurWithOptions(r.image, sigma, options.MinAmpl, options.Precision)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenGaussblur(r.image, sigma)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Getpoint(x int, y int, options *GetpointOptions) ([]float64, error) {
	if options != nil {
		outArray, err := purevipsgenGetpointWithOptions(r.image, x, y, options.UnpackComplex)
		if err != nil {
			return nil, err
		}
		return outArray, nil
	}
	outArray, err := purevipsgenGetpoint(r.image, x, y)
	if err != nil {
		return nil, err
	}
	return outArray, nil
...
func (r *Image) Gifsave(filename string, options *GifsaveOptions) (error) {
	if options != nil {
		err := purevipsgenGifsaveWithOptions(r.image, filename, options.Dither, options.Effort, options.Bitdepth, options.InterframeMaxerror, options.Reuse, options.InterpaletteMaxerror, options.Interlace, options.KeepDuplicateFrames, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenGifsave(r.image, filename)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) GifsaveBuffer(options *GifsaveBufferOptions) ([]byte, error) {
	if options != nil {
		buf, err := purevipsgenGifsaveBufferWithOptions(r.image, options.Dither, options.Effort, options.Bitdepth, options.InterframeMaxerror, options.Reuse, options.InterpaletteMaxerror, options.Interlace, options.KeepDuplicateFrames, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return nil, err
		}
		return buf, nil
	}
	buf, err := purevipsgenGifsaveBuffer(r.image)
	if err != nil {
		return nil, err
	}
	return buf, nil
...
func (r *Image) GifsaveTarget(target *Target, options *GifsaveTargetOptions) (error) {
	if options != nil {
		err := purevipsgenGifsaveTargetWithOptions(r.image, target.target, options.Dither, options.Effort, options.Bitdepth, options.InterframeMaxerror, options.Reuse, options.InterpaletteMaxerror, options.Interlace, options.KeepDuplicateFrames, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenGifsaveTarget(r.image, target.target)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) Globalbalance(options *GlobalbalanceOptions) (error) {
	if options != nil {
		out, err := purevipsgenGlobalbalanceWithOptions(r.image, options.Gamma, options.IntOutput)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenGlobalbalance(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Gravity(direction CompassDirection, width int, height int, options *GravityOptions) (error) {
	if options != nil {
		out, err := purevipsgenGravityWithOptions(r.image, direction, width, height, options.Extend, options.Background)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenGravity(r.image, direction, width, height)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Grid(tileHeight int, across int, down int) (error) {
	out, err := purevipsgenGrid(r.image, tileHeight, across, down)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Heifsave(filename string, options *HeifsaveOptions) (error) {
	if options != nil {
		err := purevipsgenHeifsaveWithOptions(r.image, filename, options.Q, options.Bitdepth, options.Lossless, options.Compression, options.Effort, options.SubsampleMode, options.Encoder, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenHeifsave(r.image, filename)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) HeifsaveBuffer(options *HeifsaveBufferOptions) ([]byte, error) {
	if options != nil {
		buf, err := purevipsgenHeifsaveBufferWithOptions(r.image, options.Q, options.Bitdepth, options.Lossless, options.Compression, options.Effort, options.SubsampleMode, options.Encoder, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return nil, err
		}
		return buf, nil
	}
	buf, err := purevipsgenHeifsaveBuffer(r.image)
	if err != nil {
		return nil, err
	}
	return buf, nil
...
func (r *Image) HeifsaveTarget(target *Target, options *HeifsaveTargetOptions) (error) {
	if options != nil {
		err := purevipsgenHeifsaveTargetWithOptions(r.image, target.target, options.Q, options.Bitdepth, options.Lossless, options.Compression, options.Effort, options.SubsampleMode, options.Encoder, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenHeifsaveTarget(r.image, target.target)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) HistCum() (error) {
	out, err := purevipsgenHistCum(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) HistEntropy() (float64, error) {
	out, err := purevipsgenHistEntropy(r.image)
	if err != nil {
		return 0, err
	}
	return out, nil
...
func (r *Image) HistEqual(options *HistEqualOptions) (error) {
	if options != nil {
		out, err := purevipsgenHistEqualWithOptions(r.image, options.Band)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenHistEqual(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) HistFind(options *HistFindOptions) (error) {
	if options != nil {
		out, err := purevipsgenHistFindWithOptions(r.image, options.Band)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenHistFind(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) HistFindIndexed(index *Image, options *HistFindIndexedOptions) (error) {
	if options != nil {
		out, err := purevipsgenHistFindIndexedWithOptions(r.image, index.image, options.Combine)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenHistFindIndexed(r.image, index.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) HistFindNdim(options *HistFindNdimOptions) (error) {
	if options != nil {
		out, err := purevipsgenHistFindNdimWithOptions(r.image, options.Bins)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenHistFindNdim(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) HistIsmonotonic() (bool, error) {
	monotonic, err := purevipsgenHistIsmonotonic(r.image)
	if err != nil {
		return false, err
	}
...
func (r *Image) HistLocal(width int, height int, options *HistLocalOptions) (error) {
	if options != nil {
		out, err := purevipsgenHistLocalWithOptions(r.image, width, height, options.MaxSlope)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenHistLocal(r.image, width, height)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) HistMatch(ref *Image) (error) {
	out, err := purevipsgenHistMatch(r.image, ref.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) HistNorm() (error) {
	out, err := purevipsgenHistNorm(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) HistPlot() (error) {
	out, err := purevipsgenHistPlot(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) HoughCircle(options *HoughCircleOptions) (error) {
	if options != nil {
		out, err := purevipsgenHoughCircleWithOptions(r.image, options.Scale, options.MinRadius, options.MaxRadius)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenHoughCircle(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) HoughLine(options *HoughLineOptions) (error) {
	if options != nil {
		out, err := purevipsgenHoughLineWithOptions(r.image, options.Width, options.Height)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenHoughLine(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) IccExport(options *IccExportOptions) (error) {
	if options != nil {
		out, err := purevipsgenIccExportWithOptions(r.image, options.Pcs, options.Intent, options.BlackPointCompensation, options.OutputProfile, options.Depth)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenIccExport(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) IccImport(options *IccImportOptions) (error) {
	if options != nil {
		out, err := purevipsgenIccImportWithOptions(r.image, options.Pcs, options.Intent, options.BlackPointCompensation, options.Embedded, options.InputProfile)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenIccImport(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) IccTransform(outputProfile string, options *IccTransformOptions) (error) {
	if options != nil {
		out, err := purevipsgenIccTransformWithOptions(r.image, outputProfile, options.Pcs, options.Intent, options.BlackPointCompensation, options.Embedded, options.InputProfile, options.Depth)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenIccTransform(r.image, outputProfile)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Ifthenelse(in1 *Image, in2 *Image, options *IfthenelseOptions) (error) {
	if options != nil {
		out, err := purevipsgenIfthenelseWithOptions(r.image, in1.image, in2.image, options.Blend)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenIfthenelse(r.image, in1.image, in2.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Insert(sub *Image, x int, y int, options *InsertOptions) (error) {
	if options != nil {
		out, err := purevipsgenInsertWithOptions(r.image, sub.image, x, y, options.Expand, options.Background)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenInsert(r.image, sub.image, x, y)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Invert() (error) {
	out, err := purevipsgenInvert(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Invertlut(options *InvertlutOptions) (error) {
	if options != nil {
		out, err := purevipsgenInvertlutWithOptions(r.image, options.Size)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenInvertlut(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Invfft(options *InvfftOptions) (error) {
	if options != nil {
		out, err := purevipsgenInvfftWithOptions(r.image, options.Real)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenInvfft(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Join(in2 *Image, direction Direction, options *JoinOptions) (error) {
	if options != nil {
		out, err := purevipsgenJoinWithOptions(r.image, in2.image, direction, options.Expand, options.Shim, options.Background, options.Align)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenJoin(r.image, in2.image, direction)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Jp2ksave(filename string, options *Jp2ksaveOptions) (error) {
	if options != nil {
		err := purevipsgenJp2ksaveWithOptions(r.image, filename, options.TileWidth, options.TileHeight, options.Lossless, options.Q, options.SubsampleMode, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenJp2ksave(r.image, filename)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) Jp2ksaveBuffer(options *Jp2ksaveBufferOptions) ([]byte, error) {
	if options != nil {
		buf, err := purevipsgenJp2ksaveBufferWithOptions(r.image, options.TileWidth, options.TileHeight, options.Lossless, options.Q, options.SubsampleMode, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return nil, err
		}
		return buf, nil
	}
	buf, err := purevipsgenJp2ksaveBuffer(r.image)
	if err != nil {
		return nil, err
	}
	return buf, nil
...
func (r *Image) Jp2ksaveTarget(target *Target, options *Jp2ksaveTargetOptions) (error) {
	if options != nil {
		err := purevipsgenJp2ksaveTargetWithOptions(r.image, target.target, options.TileWidth, options.TileHeight, options.Lossless, options.Q, options.SubsampleMode, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenJp2ksaveTarget(r.image, target.target)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) Jxlsave(filename string, options *JxlsaveOptions) (error) {
	if options != nil {
		err := purevipsgenJxlsaveWithOptions(r.image, filename, options.Tier, options.Distance, options.Effort, options.Lossless, options.Q, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenJxlsave(r.image, filename)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) JxlsaveBuffer(options *JxlsaveBufferOptions) ([]byte, error) {
	if options != nil {
		buf, err := purevipsgenJxlsaveBufferWithOptions(r.image, options.Tier, options.Distance, options.Effort, options.Lossless, options.Q, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return nil, err
		}
		return buf, nil
	}
	buf, err := purevipsgenJxlsaveBuffer(r.image)
	if err != nil {
		return nil, err
	}
	return buf, nil
...
func (r *Image) JxlsaveTarget(target *Target, options *JxlsaveTargetOptions) (error) {
	if options != nil {
		err := purevipsgenJxlsaveTargetWithOptions(r.image, target.target, options.Tier, options.Distance, options.Effort, options.Lossless, options.Q, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenJxlsaveTarget(r.image, target.target)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) Labelregions(options *LabelregionsOptions) (error) {
	if options != nil {
		out, err := purevipsgenLabelregionsWithOptions(r.image, &options.Segments)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenLabelregions(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Linear(a []float64, b []float64, options *LinearOptions) (error) {
	if options != nil {
		out, err := purevipsgenLinearWithOptions(r.image, a, b, options.Uchar)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenLinear(r.image, a, b)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Linecache(options *LinecacheOptions) (*Image, error) {
	if options != nil {
		out, err := purevipsgenLinecacheWithOptions(r.image, options.TileHeight, options.Access, options.Threaded, options.Persistent)
		if err != nil {
			return nil, err
		}
		outImage := newImageRef(out, r.format, nil)
	...
	out, err := purevipsgenLinecache(r.image)
	if err != nil {
		return nil, err
	}
	outImage := newImageRef(out, r.format, nil)
...
func (r *Image) Magicksave(filename string, options *MagicksaveOptions) (error) {
	if options != nil {
		err := purevipsgenMagicksaveWithOptions(r.image, filename, options.Format, options.Quality, options.OptimizeGifFrames, options.OptimizeGifTransparency, options.Bitdepth, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenMagicksave(r.image, filename)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) MagicksaveBuffer(options *MagicksaveBufferOptions) ([]byte, error) {
	if options != nil {
		buf, err := purevipsgenMagicksaveBufferWithOptions(r.image, options.Format, options.Quality, options.OptimizeGifFrames, options.OptimizeGifTransparency, options.Bitdepth, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return nil, err
		}
		return buf, nil
	}
	buf, err := purevipsgenMagicksaveBuffer(r.image)
	if err != nil {
		return nil, err
	}
	return buf, nil
...
func (r *Image) Mapim(index *Image, options *MapimOptions) (error) {
	if options != nil {
		out, err := purevipsgenMapimWithOptions(r.image, index.image, options.Interpolate, options.Background, options.Premultiplied, options.Extend)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenMapim(r.image, index.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Maplut(lut *Image, options *MaplutOptions) (error) {
	if options != nil {
		out, err := purevipsgenMaplutWithOptions(r.image, lut.image, options.Band)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenMaplut(r.image, lut.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Match(sec *Image, xr1 int, yr1 int, xs1 int, ys1 int, xr2 int, yr2 int, xs2 int, ys2 int, options *MatchOptions) (error) {
	if options != nil {
		out, err := purevipsgenMatchWithOptions(r.image, sec.image, xr1, yr1, xs1, ys1, xr2, yr2, xs2, ys2, options.Hwindow, options.Harea, options.Search, options.Interpolate)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenMatch(r.image, sec.image, xr1, yr1, xs1, ys1, xr2, yr2, xs2, ys2)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Math(math OperationMath) (error) {
	out, err := purevipsgenMath(r.image, math)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Math2(right *Image, math2 OperationMath2) (error) {
	out, err := purevipsgenMath2(r.image, right.image, math2)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Math2Const(math2 OperationMath2, c []float64) (error) {
	out, err := purevipsgenMath2Const(r.image, math2, c)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Matrixinvert() (error) {
	out, err := purevipsgenMatrixinvert(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Matrixmultiply(right *Image) (error) {
	out, err := purevipsgenMatrixmultiply(r.image, right.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Matrixprint(options *MatrixprintOptions) (error) {
	if options != nil {
		err := purevipsgenMatrixprintWithOptions(r.image, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenMatrixprint(r.image)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) Matrixsave(filename string, options *MatrixsaveOptions) (error) {
	if options != nil {
		err := purevipsgenMatrixsaveWithOptions(r.image, filename, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenMatrixsave(r.image, filename)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) MatrixsaveTarget(target *Target, options *MatrixsaveTargetOptions) (error) {
	if options != nil {
		err := purevipsgenMatrixsaveTargetWithOptions(r.image, target.target, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenMatrixsaveTarget(r.image, target.target)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) Max(options *MaxOptions) (float64, error) {
	if options != nil {
		out, err := purevipsgenMaxWithOptions(r.image, options.Size, &options.X, &options.Y)
		if err != nil {
			return 0, err
		}
		return out, nil
	}
	out, err := purevipsgenMax(r.image)
	if err != nil {
		return 0, err
	}
	return out, nil
...
func (r *Image) Maxpair(right *Image) (error) {
	out, err := purevipsgenMaxpair(r.image, right.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Measure(h int, v int, options *MeasureOptions) (error) {
	if options != nil {
		out, err := purevipsgenMeasureWithOptions(r.image, h, v, options.Left, options.Top, options.Width, options.Height)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenMeasure(r.image, h, v)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Merge(sec *Image, direction Direction, dx int, dy int, options *MergeOptions) (error) {
	if options != nil {
		out, err := purevipsgenMergeWithOptions(r.image, sec.image, direction, dx, dy, options.Mblend)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenMerge(r.image, sec.image, direction, dx, dy)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Min(options *MinOptions) (float64, error) {
	if options != nil {
		out, err := purevipsgenMinWithOptions(r.image, options.Size, &options.X, &options.Y)
		if err != nil {
			return 0, err
		}
		return out, nil
	}
	out, err := purevipsgenMin(r.image)
	if err != nil {
		return 0, err
	}
	return out, nil
...
func (r *Image) Minpair(right *Image) (error) {
	out, err := purevipsgenMinpair(r.image, right.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Morph(mask *Image, morph OperationMorphology) (error) {
	out, err := purevipsgenMorph(r.image, mask.image, morph)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Mosaic(sec *Image, direction Direction, xref int, yref int, xsec int, ysec int, options *MosaicOptions) (error) {
	if options != nil {
		out, err := purevipsgenMosaicWithOptions(r.image, sec.image, direction, xref, yref, xsec, ysec, options.Hwindow, options.Harea, options.Mblend, options.Bandno, &options.Dx0, &options.Dy0, &options.Scale1, &options.Angle1, &options.Dy1, &options.Dx1)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenMosaic(r.image, sec.image, direction, xref, yref, xsec, ysec)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Mosaic1(sec *Image, direction Direction, xr1 int, yr1 int, xs1 int, ys1 int, xr2 int, yr2 int, xs2 int, ys2 int, options *Mosaic1Options) (error) {
	if options != nil {
		out, err := purevipsgenMosaic1WithOptions(r.image, sec.image, direction, xr1, yr1, xs1, ys1, xr2, yr2, xs2, ys2, options.Hwindow, options.Harea, options.Search, options.Interpolate, options.Mblend)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenMosaic1(r.image, sec.image, direction, xr1, yr1, xs1, ys1, xr2, yr2, xs2, ys2)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Msb(options *MsbOptions) (error) {
	if options != nil {
		out, err := purevipsgenMsbWithOptions(r.image, options.Band)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenMsb(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Multiply(right *Image) (error) {
	out, err := purevipsgenMultiply(r.image, right.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Percent(percent float64) (int, error) {
	threshold, err := purevipsgenPercent(r.image, percent)
	if err != nil {
		return 0, err
	}
...
func (r *Image) Phasecor(in2 *Image) (error) {
	out, err := purevipsgenPhasecor(r.image, in2.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Pngsave(filename string, options *PngsaveOptions) (error) {
	if options != nil {
		err := purevipsgenPngsaveWithOptions(r.image, filename, options.Compression, options.Interlace, options.Filter, options.Palette, options.Q, options.Dither, options.Bitdepth, options.Effort, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenPngsave(r.image, filename)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) Ppmsave(filename string, options *PpmsaveOptions) (error) {
	if options != nil {
		err := purevipsgenPpmsaveWithOptions(r.image, filename, options.Format, options.Ascii, options.Bitdepth, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenPpmsave(r.image, filename)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) PpmsaveTarget(target *Target, options *PpmsaveTargetOptions) (error) {
	if options != nil {
		err := purevipsgenPpmsaveTargetWithOptions(r.image, target.target, options.Format, options.Ascii, options.Bitdepth, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenPpmsaveTarget(r.image, target.target)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) Premultiply(options *PremultiplyOptions) (error) {
	if options != nil {
		out, err := purevipsgenPremultiplyWithOptions(r.image, options.MaxAlpha)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenPremultiply(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Prewitt() (error) {
	out, err := purevipsgenPrewitt(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Profile() (*Image, *Image, error) {
	columns, rows, err := purevipsgenProfile(r.image)
	if err != nil {
		return nil, nil, err
	}
...
func (r *Image) Project() (*Image, *Image, error) {
	columns, rows, err := purevipsgenProject(r.image)
	if err != nil {
		return nil, nil, err
	}
	columnsImage := newImageRef(columns, r.format, nil)
...
func (r *Image) Quadratic(coeff *Image, options *QuadraticOptions) (error) {
	if options != nil {
		out, err := purevipsgenQuadraticWithOptions(r.image, coeff.image, options.Interpolate)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenQuadratic(r.image, coeff.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Rad2float() (error) {
	out, err := purevipsgenRad2float(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Radsave(filename string, options *RadsaveOptions) (error) {
	if options != nil {
		err := purevipsgenRadsaveWithOptions(r.image, filename, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenRadsave(r.image, filename)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) RadsaveBuffer(options *RadsaveBufferOptions) ([]byte, error) {
	if options != nil {
		buf, err := purevipsgenRadsaveBufferWithOptions(r.image, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return nil, err
		}
		return buf, nil
	}
	buf, err := purevipsgenRadsaveBuffer(r.image)
	if err != nil {
		return nil, err
	}
	return buf, nil
...
func (r *Image) RadsaveTarget(target *Target, options *RadsaveTargetOptions) (error) {
	if options != nil {
		err := purevipsgenRadsaveTargetWithOptions(r.image, target.target, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenRadsaveTarget(r.image, target.target)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) Rank(width int, height int, index int) (error) {
	out, err := purevipsgenRank(r.image, width, height, index)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Rawsave(filename string, options *RawsaveOptions) (error) {
	if options != nil {
		err := purevipsgenRawsaveWithOptions(r.image, filename, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenRawsave(r.image, filename)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) RawsaveBuffer(options *RawsaveBufferOptions) ([]byte, error) {
	if options != nil {
		buf, err := purevipsgenRawsaveBufferWithOptions(r.image, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return nil, err
		}
		return buf, nil
	}
	buf, err := purevipsgenRawsaveBuffer(r.image)
	if err != nil {
		return nil, err
	}
	return buf, nil
...
func (r *Image) RawsaveTarget(target *Target, options *RawsaveTargetOptions) (error) {
	if options != nil {
		err := purevipsgenRawsaveTargetWithOptions(r.image, target.target, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenRawsaveTarget(r.image, target.target)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) Recomb(m *Image) (error) {
	out, err := purevipsgenRecomb(r.image, m.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Reduce(hshrink float64, vshrink float64, options *ReduceOptions) (error) {
	if options != nil {
		out, err := purevipsgenReduceWithOptions(r.image, hshrink, vshrink, options.Kernel, options.Gap)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenReduce(r.image, hshrink, vshrink)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Reduceh(hshrink float64, options *ReducehOptions) (error) {
	if options != nil {
		out, err := purevipsgenReducehWithOptions(r.image, hshrink, options.Kernel, options.Gap)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenReduceh(r.image, hshrink)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Reducev(vshrink float64, options *ReducevOptions) (error) {
	if options != nil {
		out, err := purevipsgenReducevWithOptions(r.image, vshrink, options.Kernel, options.Gap)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenReducev(r.image, vshrink)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Relational(right *Image, relational OperationRelational) (error) {
	out, err := purevipsgenRelational(r.image, right.image, relational)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) RelationalConst(relational OperationRelational, c []float64) (error) {
	out, err := purevipsgenRelationalConst(r.image, relational, c)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Remainder(right *Image) (error) {
	out, err := purevipsgenRemainder(r.image, right.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) RemainderConst(c []float64) (error) {
	out, err := purevipsgenRemainderConst(r.image, c)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Remosaic(oldStr string, newStr string) (error) {
	out, err := purevipsgenRemosaic(r.image, oldStr, newStr)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Replicate(across int, down int) (error) {
	out, err := purevipsgenReplicate(r.image, across, down)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Resize(scale float64, options *ResizeOptions) (error) {
	if options != nil {
		out, err := purevipsgenResizeWithOptions(r.image, scale, options.Kernel, options.Gap, options.Vscale)
		if err != nil {
			return err
		}
		r.setImage(out)
...
func (r *Image) Rot(angle Angle) (error) {
	out, err := purevipsgenRot(r.image, angle)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Rot45(options *Rot45Options) (error) {
	if options != nil {
		out, err := purevipsgenRot45WithOptions(r.image, options.Angle)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenRot45(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Rotate(angle float64, options *RotateOptions) (error) {
	if options != nil {
		out, err := purevipsgenRotateWithOptions(r.image, angle, options.Interpolate, options.Background, options.Odx, options.Ody, options.Idx, options.Idy)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenRotate(r.image, angle)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Round(round OperationRound) (error) {
	out, err := purevipsgenRound(r.image, round)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) SRGB2HSV() (error) {
	out, err := purevipsgenSRGB2HSV(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) SRGB2scRGB() (error) {
	out, err := purevipsgenSRGB2scRGB(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) ScRGB2BW(options *ScRGB2BWOptions) (error) {
	if options != nil {
		out, err := purevipsgenScRGB2BWWithOptions(r.image, options.Depth)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenScRGB2BW(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) ScRGB2XYZ() (error) {
	out, err := purevipsgenScRGB2XYZ(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) ScRGB2sRGB(options *ScRGB2sRGBOptions) (error) {
	if options != nil {
		out, err := purevipsgenScRGB2sRGBWithOptions(r.image, options.Depth)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenScRGB2sRGB(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Scale(options *ScaleOptions) (error) {
	if options != nil {
		out, err := purevipsgenScaleWithOptions(r.image, options.Exp, options.Log)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenScale(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Scharr() (error) {
	out, err := purevipsgenScharr(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Sequential(options *SequentialOptions) (*Image, error) {
	if options != nil {
		out, err := purevipsgenSequentialWithOptions(r.image, options.TileHeight)
		if err != nil {
			return nil, err
		}
		outImage := newImageRef(out, r.format, nil)
	...
	out, err := purevipsgenSequential(r.image)
	if err != nil {
		return nil, err
	}
	outImage := newImageRef(out, r.format, nil)
...
func (r *Image) Sharpen(options *SharpenOptions) (error) {
	if options != nil {
		out, err := purevipsgenSharpenWithOptions(r.image, options.Sigma, options.X1, options.Y2, options.Y3, options.M1, options.M2)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenSharpen(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Shrink(hshrink float64, vshrink float64, options *ShrinkOptions) (error) {
	if options != nil {
		out, err := purevipsgenShrinkWithOptions(r.image, hshrink, vshrink, options.Ceil)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenShrink(r.image, hshrink, vshrink)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Shrinkh(hshrink int, options *ShrinkhOptions) (error) {
	if options != nil {
		out, err := purevipsgenShrinkhWithOptions(r.image, hshrink, options.Ceil)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenShrinkh(r.image, hshrink)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Shrinkv(vshrink int, options *ShrinkvOptions) (error) {
	if options != nil {
		out, err := purevipsgenShrinkvWithOptions(r.image, vshrink, options.Ceil)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenShrinkv(r.image, vshrink)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Sign() (error) {
	out, err := purevipsgenSign(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Similarity(options *SimilarityOptions) (error) {
	if options != nil {
		out, err := purevipsgenSimilarityWithOptions(r.image, options.Scale, options.Angle, options.Interpolate, options.Background, options.Odx, options.Ody, options.Idx, options.Idy)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenSimilarity(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Smartcrop(width int, height int, options *SmartcropOptions) (error) {
	if options != nil {
		out, err := purevipsgenSmartcropWithOptions(r.image, width, height, options.Interesting, options.Premultiplied, &options.AttentionX, &options.AttentionY)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenSmartcrop(r.image, width, height)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Sobel() (error) {
	out, err := purevipsgenSobel(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Spcor(ref *Image) (error) {
	out, err := purevipsgenSpcor(r.image, ref.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Spectrum() (error) {
	out, err := purevipsgenSpectrum(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Stats() (error) {
	out, err := purevipsgenStats(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Stdif(width int, height int, options *StdifOptions) (error) {
	if options != nil {
		out, err := purevipsgenStdifWithOptions(r.image, width, height, options.S0, options.B, options.M0, options.A)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenStdif(r.image, width, height)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Subsample(xfac int, yfac int, options *SubsampleOptions) (error) {
	if options != nil {
		out, err := purevipsgenSubsampleWithOptions(r.image, xfac, yfac, options.Point)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenSubsample(r.image, xfac, yfac)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Subtract(right *Image) (error) {
	out, err := purevipsgenSubtract(r.image, right.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) ThumbnailImage(width int, options *ThumbnailImageOptions) (error) {
	if options != nil {
		out, err := purevipsgenThumbnailImageWithOptions(r.image, width, options.Height, options.Size, options.NoRotate, options.Crop, options.Linear, options.InputProfile, options.OutputProfile, options.Intent, options.FailOn)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenThumbnailImage(r.image, width)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) TiffsaveBuffer(options *TiffsaveBufferOptions) ([]byte, error) {
	if options != nil {
		buf, err := purevipsgenTiffsaveBufferWithOptions(r.image, options.Compression, options.Q, options.Predictor, options.Tile, options.TileWidth, options.TileHeight, options.Pyramid, options.Miniswhite, options.Bitdepth, options.Resunit, options.Xres, options.Yres, options.Bigtiff, options.Properties, options.RegionShrink, options.Level, options.Lossless, options.Depth, options.Subifd, options.Premultiply, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return nil, err
		}
		return buf, nil
	}
	buf, err := purevipsgenTiffsaveBuffer(r.image)
	if err != nil {
		return nil, err
	}
	return buf, nil
...
func (r *Image) TiffsaveTarget(target *Target, options *TiffsaveTargetOptions) (error) {
	if options != nil {
		err := purevipsgenTiffsaveTargetWithOptions(r.image, target.target, options.Compression, options.Q, options.Predictor, options.Tile, options.TileWidth, options.TileHeight, options.Pyramid, options.Miniswhite, options.Bitdepth, options.Resunit, options.Xres, options.Yres, options.Bigtiff, options.Properties, options.RegionShrink, options.Level, options.Lossless, options.Depth, options.Subifd, options.Premultiply, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenTiffsaveTarget(r.image, target.target)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) Tilecache(options *TilecacheOptions) (*Image, error) {
	if options != nil {
		out, err := purevipsgenTilecacheWithOptions(r.image, options.TileWidth, options.TileHeight, options.MaxTiles, options.Access, options.Threaded, options.Persistent)
		if err != nil {
			return nil, err
		}
		outImage := newImageRef(out, r.format, nil)
	...
	out, err := purevipsgenTilecache(r.image)
	if err != nil {
		return nil, err
	}
	outImage := newImageRef(out, r.format, nil)
...
func (r *Image) Transpose3d(options *Transpose3dOptions) (error) {
	if options != nil {
		out, err := purevipsgenTranspose3dWithOptions(r.image, options.PageHeight)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenTranspose3d(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Unpremultiply(options *UnpremultiplyOptions) (error) {
	if options != nil {
		out, err := purevipsgenUnpremultiplyWithOptions(r.image, options.MaxAlpha, options.AlphaBand)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenUnpremultiply(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Vipssave(filename string, options *VipssaveOptions) (error) {
	if options != nil {
		err := purevipsgenVipssaveWithOptions(r.image, filename, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenVipssave(r.image, filename)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) VipssaveTarget(target *Target, options *VipssaveTargetOptions) (error) {
	if options != nil {
		err := purevipsgenVipssaveTargetWithOptions(r.image, target.target, options.Keep, options.Background, options.PageHeight, options.Profile)
		if err != nil {
			return err
		}
		return nil
	}
	err := purevipsgenVipssaveTarget(r.image, target.target)
	if err != nil {
		return err
	}
	return nil
...
func (r *Image) Wrap(options *WrapOptions) (error) {
	if options != nil {
		out, err := purevipsgenWrapWithOptions(r.image, options.X, options.Y)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	out, err := purevipsgenWrap(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) Zoom(xfac int, yfac int) (error) {
	out, err := purevipsgenZoom(r.image, xfac, yfac)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func ProfileLoad(name string) ([]byte, error) {
	Startup(nil)
	return purevipsgenProfileLoad(name)
}
...
func NewImageFromSource(s *Source, options *LoadOptions) (*Image, error) {
	...
	vipsImage, err := purevipsgenImageFromSource(s.src, options)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, vipsDetermineImageType(vipsImage), nil), nil
...
func NewImageFromBuffer(buf []byte, options *LoadOptions) (*Image, error) {
	...
	vipsImage, err := purevipsgenImageFromBuffer(buf, options)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, vipsDetermineImageType(vipsImage), buf), nil
...
func NewImageFromFile(file string, options *LoadOptions) (*Image, error) {
	...
	if _, err := os.Stat(file); err != nil {
		return nil, fmt.Errorf("%s does not exist: %w", file, err)
	}
	if options == nil {
		options = DefaultLoadOptions()
	}
	vipsImage, err := purevipsgenImageFromFile(file, options)
	if err != nil {
		return nil, err
	}
	return newImageRef(vipsImage, vipsDetermineImageType(vipsImage), nil), nil
...
func NewImageFromMemory(buf []byte, width, height, bands int) (*Image, error) {
	Startup(nil)
	vipsImage, err := purevipsgenImageFromMemory(buf, width, height, bands)
	if err != nil {
		return nil, err
	}
...
func (r *Image) WriteToMemory() ([]byte, error) {
	return purevipsgenImageWriteToMemory(r.image)
}


func newImageRef(vipsImage vipsImageRef, format ImageType, buf []byte) *Image {
	imageRef := &Image{
		image:  vipsImage,
		format: format,
		buf:    buf,
	}
	log("purevipsgen", LogLevelDebug, fmt.Sprintf("created imageRef %p", imageRef))
	return imageRef
}

// setImage resets the image for this image and frees the previous one
func (r *Image) setImage(image vipsImageRef) {
	r.lock.Lock()
	defer r.lock.Unlock()
	if r.image == image {
		return
...
func (r *Image) Close() {
	...
	if r.image != nil {
		clearImage(r.image)
		r.image = nil
		log("purevipsgen", LogLevelDebug, fmt.Sprintf("closing image %p", r))
	}
	r.buf = nil
	r.lock.Unlock()
}
...
func (r *Image) ResX() float64 {
	var f func(vipsImageRef) float64
	registerVipsFunc(&f, "vips_image_get_xres")
	return f(r.image)
}
...
func (r *Image) ResY() float64 {
	var f func(vipsImageRef) float64
	registerVipsFunc(&f, "vips_image_get_yres")
	return f(r.image)
}
...
func (r *Image) OffsetX() int {
	var f func(vipsImageRef) int32
	registerVipsFunc(&f, "vips_image_get_xoffset")
	return int(f(r.image))
}
...
func (r *Image) OffsetY() int {
	var f func(vipsImageRef) int32
	registerVipsFunc(&f, "vips_image_get_yoffset")
	return int(f(r.image))
}
...
func (r *Image) BandFormat() BandFormat {
	var f func(vipsImageRef) int32
	registerVipsFunc(&f, "vips_image_get_format")
	return BandFormat(f(r.image))
}

// Coding returns the image coding
func (r *Image) Coding() Coding {
	var f func(vipsImageRef) int32
	registerVipsFunc(&f, "vips_image_get_coding")
	return Coding(f(r.image))
}
...
func (r *Image) Interpretation() Interpretation {
	var f func(vipsImageRef) int32
	registerVipsFunc(&f, "vips_image_get_interpretation")
	return Interpretation(f(r.image))
}
...
func (r *Image) RemoveExif() error {
	out, err := purevipsgenRemoveExif(r.image)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) EmbedMultiPage(left, top, width, height int, options *EmbedMultiPageOptions) error {
	...
	if r.Height() == r.PageHeight() {
		out, err := purevipsgenEmbedWithOptions(r.image, left, top, width, height, options.Extend, options.Background)
		if err != nil {
			return err
		}
		r.setImage(out)
	...
	if options.Extend == ExtendBackground {
		...
		out, err := purevipsgenEmbedMultiPageBackground(
			r.image,
	...
	out, err := purevipsgenEmbedMultiPage(r.image, left, top, width, height, options.Extend)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) ExtractAreaMultiPage(left, top, width, height int) error {
	...
	out, err := purevipsgenExtractAreaMultiPage(r.image, left, top, width, height)
	if err != nil {
		return err
	}
	r.setImage(out)
...
func (r *Image) RotMultiPage(angle Angle) error {
	...
	out, err := purevipsgenRotMultiPage(r.image, angle)
	if err != nil {
		return err
	}
	r.setImage(out)
